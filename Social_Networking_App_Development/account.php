...
<html>
<title>Social_Network - Get Connected</title>
...
<body>
    <nav>
      ...
      <ul class="menu-items">
        ...
        <li class="menu-items-li"><a class="navv-item" href="friends.php">Friends</a></li>
        <li class="menu-items-li"><a class="navv-item" href="search.php">Search</a></li>
      </ul>
            ...
            ?>
                <a href="account.php?username=<?php echo $username_row; ?>">
                    ...
                    <img class="user-avatar" src="https://api.dicebear.com/6.x/initials/png?seed=<?php echo $fname ?>&size=128" alt="User 1">
                        <!-- <img class="user-avatar" src="<?php echo $avatarPath ?>" alt="User 1"> -->
                        <div class="user-info">
    ...
    <?php if (isset($_GET['username'])) { ?>
        ...
        $sql = "SELECT `id`, `username`, `fname`, `lname`, `email`, `password`, `status` `avatar_path` FROM `users` WHERE `username` = '$username';";
        $result = mysqli_query($connection, $sql);
        ...
        <div class="account">
            <div class="account-body">
                <div class="account-banner" style="background-image: url('logo/banner1.jpg');">
                    <div class="account-img">
                        <ul>
                            
                            <li>
                            <form action="upload_avatar.php" method="post" enctype="multipart/form-data">
                            Select Avatar:<input type="file" name="avatar" id="Avatar-profile">
                            <button class="btn btn-outline-secondary" type="submit" id="button-addon2" value="Upload Avatar" name="submit">Submit</button>
                            </form>
                            <img class="user-avatar" src="https://api.dicebear.com/6.x/initials/png?seed=<?php echo $fname ?>&size=128" alt="User 1">
                            <!-- <img class="user-avatar" src="<?php echo  $avatarPath; ?>" alt="User 1"> -->
