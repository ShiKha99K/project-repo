...
<html>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="logo/Social_Network logo1.png" type="image/png">
...
<body>
    <nav>
      ...
      <ul>
        <img src="img/dark_img/MoonIcon.jpg" alt="Theme Icon" height="19" width="19" id="theme-icon" id="theme-toggle" class="theme-button" onclick="changeTheme()">
      </ul>
      <label class="logo"><a href="index.php"><img class="logo" src="logo/Social_Network logo1.png"></a></label>
      <ul class="menu-items">
...
<div class="about-us">
    <center><img class="about-us-logo" src="logo/Social_Network logo1.png" alt="logo"></center>
    <h2>About Us</h2>
    <p>Social_Network is a social networking site where users can share their posts, images, and chat with each other. It was created to provide a seamless experience to people who want to connect with others and share their experiences.</p>
    <p>We believe that social media can be used to bring people together and create positive changes in the world. Social_Network is a platform that empowers people to express themselves and share their ideas with a wider audience.</p>
    
</div>

<div class="footer" style="height:16rem">
        <p style="  font-size: x-large;margin-top:0;">Social_Network</p>
    ...
    <p style="font-size:0.9rem;">This website is for Mini Project on Modern Web Development Workshop – 2 (CSE 2192) (4th Semester) Project Title: Social Networking App Development - by Shikha Kumari</p>
</div>
